    ...
    class ProgressionCallback : AndroidJavaProxy
    {
        ...
        void success(AndroidJavaObject dataObj)
        {
            if (dataObj == null)
            {
                ...
                {
                    SkillzDebug.Log(SkillzDebug.Type.SIDEKICK, $"UpdateProgressionUserData() Success Callback, progression data: {SkillzDebug.Format(new Dictionary<string, ProgressionValue>())}");
            ...
            if (successCallback != null)
            {
                SkillzDebug.Log(SkillzDebug.Type.SIDEKICK, $"GetProgressionUserData() Success Callback, progression data: {SkillzDebug.Format(data)}");
        ...
        void failure(AndroidJavaObject errorObj)
        {
            ...
            if (failureCallback != null)
            {
                ...
                SkillzDebug.Log(SkillzDebug.Type.SKILLZ, $"ProgressionUserData Failure Callback: {errorMessage}");
