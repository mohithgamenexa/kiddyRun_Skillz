...
Shader "Skybox/Cubemap Extended"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 appendResult56 = (float3(cos( radians( ( 0 + ( mulTime701 * 0 ) ) ) ) , 0.0 , ( sin( radians( ( _Rotation + ( mulTime701 * 0 ) ) ) ) * -1.0 )));
			float3 appendResult266 = (float3(0.0 , CAMERA_MODE300 , 0.0));
			float3 appendResult58 = (float3(sin( radians( ( 0 + ( mulTime701 * 0 ) ) ) ) , 0.0 , cos( radians( ( _Rotation + ( mulTime701 * 0 ) ) ) )));
